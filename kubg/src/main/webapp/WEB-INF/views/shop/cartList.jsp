 ...
 */
 ...
 section#content div.gdsInfo .delete button { font-size:13px;
	...
	<section id="container">
		<div id="container_box">
			...
			<ul>
				 ...
				 <!-- 체크박스 전체선택 스크립트(제이쿼리 선택자이므로 제이쿼리cdn추가) -->
				 	<script>
				...
				<!-- 체크박스 전체선택해제 스크립트(제이쿼리 선택자이므로 제이쿼리cdn추가)   -->
					<script>
				...
				<div class="orderInfo">
				 <form role="form" method="post" autocomplete="off">
				  ...
				  <div class="inputArea">
				   ...
				   <input type="text" name="orderPhon" id="orderPhon" required="required" placeholder="'-'없이 입력"/>
				  </div>
...
<!-- 				  Daum 주소 API 사용시 주석 
 ...
 -->
 					...
 					<!-- Daum(다음) 주소 API iframe을 이용하여 레이어 띄우기, input에 name 속성값 추가 -->
 					<div class="inputArea"> 
