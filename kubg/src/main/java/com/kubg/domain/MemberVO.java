...
/* 
com.kubg.domain은 VO(Value Object) 패키지. 주로 사용하는 데이터 타입을 저장
com.kubg.persistence는 DAO(Data Access Object) 패키지. 데이터 베이스와 접속하는 역할
com.kubg.serevice는 Service 패키지. DAO와 Controller 사이를 연결해주는 역할
 */
